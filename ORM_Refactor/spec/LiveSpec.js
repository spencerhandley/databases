...
describe("Persistent Node Chat Server", function() {
  ...
  it("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
            ...
            function () {
              ...
              var args = JSON.parse(this.body.toString())
  ...
  it("Should output all messages from the DB", function(done) {
    ...
    var queryString = "INSERT INTO messages SET text = ?, username = ?, roomname = ?, createdAt = ?;";
    var queryArgs = ["Men like you can never change!", "Javert", "main", new Date()];
